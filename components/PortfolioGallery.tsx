...
export function PortfolioGallery({
  ...
  return (
    <section
      ...
      id="archives"
    >
      <div className="max-w-7xl mx-auto bg-background/50 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden">
        {/* Header Section */}
        <div className="relative z-10 text-center pt-16 pb-8 px-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 bg-lma-gold text-background px-6 py-3 rounded-full font-medium hover:bg-lma-gold/90 transition-colors group mb-20"
          >
        ...
        <div className="hidden md:block relative overflow-hidden h-[500px] -mb-[250px]">
          <div className={`flex ${spacing} pb-8 pt-40 items-end justify-center`}>
            {images.map((image, index) => {
              ...
              const yOffset = isHovered ? -200 : isOtherHovered ? -80 : -staggerOffset
              ...
              return (
                ...
                >
                  <div
                    className="relative aspect-[4/5] w-48 md:w-56 lg:w-64 rounded-lg overflow-hidden transition-transform duration-300 group-hover:scale-105"
                    style={{
                      boxShadow: `
              ...
              .map((_, i) => (
                ...
                >
                  {images.map((image, index) => (
                    ...
                    >
                      <div
                        className="relative aspect-[4/5] w-48 rounded-lg overflow-hidden transition-transform duration-300 group-hover:scale-105"
                        style={{
                          boxShadow: `
                            rgba(0, 0, 0, 0.01) 0.796192px 0px 0.796192px 0px,
                            rgba(0, 0, 0, 0.03) 2.41451px 0px 2.41451px 0px,
